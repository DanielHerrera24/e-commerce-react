...
function Aside() {
  ...
  return (
    <aside className="md:flex flex-col md:pl-4 lg:pl-10 w-full md:w-1/4 border-r-2 md:border-[#ED1A23]">
      ...
      <div
        className={`flex flex-col md:items-center md:pb-0 absolute md:static md:z-auto z-10 left-0 w-auto md:w-auto md:pl-0 pl-7 bg-gray-200 shadow-md md:shadow-none gap-4 transition-all duration-200 ease-in ${
      ...
      >
        ...
        <article className="categorias flex justify-between flex-col md:mt-7 pr-8 mb-5">
